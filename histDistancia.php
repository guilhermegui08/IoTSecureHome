...
<head>
  ...
  <title>Historico Distancia</title>
</head>
...
<body>
  ...
  <div class="card">
    <div class="card-header"><strong>Histórico valores de Distância</strong> </div>
    <div class="card-body">
      <table class="table">
        <thead>
          <tr>
        ...
        <?php
        $ficheiro = fopen("api/Files/Distancia/log.txt", "r") or die("Nao foi possivel abrir o ficheiro");
        while (!feof($ficheiro)) :
          $data = fgets($ficheiro);
          $list = explode(";", $data);
