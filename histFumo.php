...
<head>
  ...
  <title>Historico Sensor detetor de Fumo</title>
</head>
...
<body>
  ...
  <div class="card">
    <div class="card-header"><strong>Histórico Fumo</strong> </div>
    <div class="card-body">
      <table class="table">
        <thead>
          <tr>
        ...
        <?php
        $ficheiro = fopen("api/Files/Fumo/log.txt", "r") or die("Nao foi possivel abrir o ficheiro");
        while (!feof($ficheiro)) :
          $data = fgets($ficheiro);
          $list = explode(";", $data);
