...
<head>
  ...
  <title>Historico de sensor detetor de Dioxido de Carbono</title>
</head>
...
<body>
  ...
  <div class="card">
    <div class="card-header"><strong>Histórico Dioxido de Carbono</strong> </div>
    <div class="card-body">
      <table class="table">
        <thead>
          <tr>
        ...
        <?php
        $ficheiro = fopen("api/Files/DioxidoCarbono/log.txt", "r") or die("Nao foi possivel abrir o ficheiro");
        while (!feof($ficheiro)) :
          $data = fgets($ficheiro);
          $list = explode(";", $data);
